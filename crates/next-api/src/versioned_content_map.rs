...
pub struct PathToOutputOperation(
    ...
    /// change/break?
    FxHashMap<FileSystemPath, OutputAssetsOperationSet>,
);
...
struct OutputAssetsOperationSet(
    #[bincode(with = "turbo_bincode::indexset")] FxIndexSet<OperationVc<OutputAssets>>,
);
